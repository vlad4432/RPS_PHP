...
--
-- Хост: 127.0.0.1
-- Время создания: Мар 30 2020 г., 07:51
...
(54, '', 'Admin', 'Furry', 'М', 56928632, 'maljushitskivlad@gmail.com', 'Admin', 'YWRtaW4=', 14, 1),
(91, '', 'Primer', 'Primer', 'М', 55654206, 'primer@gmail.com', 'prim', 'cHJpbXM=', 2, 3);
...
--
ALTER TABLE `user`
  MODIFY `idUser` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=92;
